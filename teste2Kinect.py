...
while 1:
	...
	rcircles = cv2.HoughCircles(rclosing,cv.CV_HOUGH_GRADIENT,2,10,param1=60,param2=30,minRadius=0,maxRadius=0)
	...
	ycircles = cv2.HoughCircles(yclosing,cv.CV_HOUGH_GRADIENT,2,10,param1=60,param2=30,minRadius=0,maxRadius=0)
	...
	bcircles = cv2.HoughCircles(bclosing,cv.CV_HOUGH_GRADIENT,2,10,param1=60,param2=30,minRadius=2,maxRadius=0)
